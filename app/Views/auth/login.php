                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form action="<?= base_url('L_auth/valid_login'); ?>" method="post">
                                        <div class="form-floating mb-3">
                                            <input name="username" class="form-control" type="text" placeholder="MR. Hodie.." />
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('L_auth/Register'); ?>">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
