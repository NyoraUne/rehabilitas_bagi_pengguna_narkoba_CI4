                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- //LINK - ini tampilan error pada register -->
                                    <?php if (session()->getFlashdata('error')) : ?>
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Perhatian!</strong> Data gagal disimpan. Error yang terjadi:
                                            <ul>
                                    ...
                                    <form action="<?= base_url('L_auth/valid_register'); ?>" method="post">
                                        <div class="row mb-3">
                                            <div class="col">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('L_auth/login'); ?>">Have an account? Go to login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
